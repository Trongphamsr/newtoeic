        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form method="get" action="${lisUserUrl}" id="formUrl">
                    <div class="row">
                        <div class="col-xs-12">
                        ...
                        <fmt:bundle basename="ApplicationResources">
                            ...
                            <display:table id="tableList" name="items.listResult" partialList="true" size="${items.totalItems}"
                                ...
                                <display:column title="<fieldset class='form-group'>
                                    ...
                                    <fieldset>
                                        <input name="checkList" type="checkbox" id="checkbox_${tableList.userId}" value="${tableList.userId}" class="check-box-element"/>
                                    </fieldset>
                                </display:column>
                                ...
                                <display:column headerClass="col-actions" titleKey="label.action">
                                    ...
                                    <a class="btn btn-sm btn-primary btn-edit" sc-url="${editUrl}" data-toggle="tooltip" onclick="update(this)" title="<fmt:message key='label.user.edit' bundle='${lang}'/>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
