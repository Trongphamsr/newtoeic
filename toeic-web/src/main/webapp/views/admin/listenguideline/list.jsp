                            ...
                            <div class="col-xs-12">
                                <div class="widget-box table-filter">
                                    <div class="widget-header">
                                        <h4 class="widget-title"><fnt:message key="label.search" bundle="${lang}"/></h4>
                                ...
                                <div class="table-btn-controls">
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            ...
                                            <a flang="info" class="btn-group btn-colvis btn btn-white btn-primary btn-bold" href="${addUrl}">
                                            <span>
                                                <i class="fa fa-plus-circle bigger-110 purple"></i>
                                            </span>
                                            </a>
                                            <button type="button" class="dt-button buttons-html5 btn btn-white btn-primary btn-bold" id="deleteAll" disabled
                                                   onclick="warningBeforeDelete()" data-toggle="tooltip" title="<fmt:message key='label.delete.all' bundle='${lang}'/>">
                                        <span>
                            ...
                            <fmt:bundle basename="ApplicationResources">
                                ...
                                <display:table id="tableList" name="items.listResult" partialList="true" size="${items.totalItems}"
                                    ...
                                    <input type='checkbox' class='check-box-element' id='checkAll'/>
                                        ...
                                        <fieldset>
                                            <input name="checkList" type="checkbox" id="checkbox_${tableList.listenGuidelineId}" value="${tableList.listenGuidelineId}" class="check-box-element"/>
                                        </fieldset>
                                    </display:column>
