...
<c:url value="/admin-each-method.html" var="eachMethodUrl">
    <c:param name="urlType" value="url_each_method"/>
</c:url>
...
<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
    ...
    <ul class="nav nav-list">
        <li class="">
            ...
            <ul class="submenu">
                <li class="">
                    <a href="${closestMethodUrl}">
                        <i class="menu-icon fa fa-caret-right"></i>
                        <fmt:message key="label.jquery.closest" bundle="${lang}"/>
                    </a>
                    <b class="arrow"></b>
                </li>
            </ul>
            ...
            <ul class="submenu">
                <li class="">
                    <a href="${eachMethodUrl}">
                        <i class="menu-icon fa fa-caret-right"></i>
                        <fmt:message key="label.jquery.each.method" bundle="${lang}"/>
                    </a>
                    <b class="arrow"></b>
                </li>
            </ul>
